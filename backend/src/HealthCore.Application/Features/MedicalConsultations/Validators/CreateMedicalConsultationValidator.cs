...
public class CreateMedicalConsultationCommandValidator : AbstractValidator<CreateMedicalConsultationCommand>
{
    public CreateMedicalConsultationCommandValidator()
    {
