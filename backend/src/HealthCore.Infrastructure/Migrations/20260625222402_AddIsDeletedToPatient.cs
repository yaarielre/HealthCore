        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Prescriptions_MedicalConsultations_MedicalConsultationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalConsultationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PresionArterial = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VitalSigns_MedicalConsultations_MedicalConsultationId",
                        column: x => x.MedicalConsultationId,
                        principalTable: "MedicalConsultations",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_MedicalConsultationId",
                table: "Prescriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VitalSigns_MedicalConsultationId",
                table: "VitalSigns",
                column: "MedicalConsultationId");
